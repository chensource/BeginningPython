...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_question(self):
        '''
        If no question exist, an approriate message should be displayed.
        '''
    ...
    def test_index_view_with_pass_question(self):
        '''
    ...
    def test_index_view_with_a_future_question_and_past_question(self):
        '''
        Even if both past and future quesion exist,only past questions should be displayed
        '''
        create_question(question_text='Past question', days=-30)
        create_question(question_text='Future question', days=30)
        response = self.client.get(reverse('polls:index'))
...
class QuestionIndexDetailTests(TestCase):
    def test_deail_view_with_a_futrue_question(self):
        '''
    ...
    def test_detail_view_with_a_past_question(self):
        ...
        '''
        past_question = create_question(question_text='Last question', days=-5)
